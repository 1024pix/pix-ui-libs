...
L'ensemble des breakpoints pour les différentes résolutions sont définis le fichier `addon/styles/_breakpoints.scss` et utilisables via la mixin `device-is`
