 ...
 * @property {boolean} [isClickable] - Rend l'étape cliquable (affichée sous forme de bouton).
 * @property {() => void} [onClick] - Callback appelé au clic sur l'étape. Sans effet si `isClickable` n'est pas fourni.
 */
