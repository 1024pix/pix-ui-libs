import ToastService from '@1024pix/nebulix-ember/services/pix-toast';
...
module('Unit | Service | toast', function (hooks) {
  ...
  module('#exists', function (hooks) {
    ...
    test('it returns true when toast in parameter exist in content array', function (assert) {
      // given
      toastService.addNotification(errorNotification);
      toastService.addNotification(informationNotification);
    ...
    test('it returns false when toast in parameter does not exist in content array', function (assert) {
      // given
      toastService.addNotification(errorNotification);
